...
export default function SearchInput({display}: ISearchInputProps) {
    return (
        <div className={`${display} items-center md:flex md:flex-row md:items-center md:justify-between md:mr-5 md:w-[60%] 2xl:w-[90%] h-[50px] bg-white rounded-[30px] px-4 sm:px-6 shadow-md`}>
            <input
